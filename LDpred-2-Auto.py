...
# # LDpred-2-Auto
# 
# In this notebook, we will use LDpred-2-Auto to calculate the Polygenic Risk Score (PRS).
# 
# **Note:** LDpred-2 needs to be installed using R.
# **Note:** LDpred-2-Auto calculates multiple Betas and then uses a formula to derive a single Beta value for all SNPs. However, we used each set of Betas estimated by the LDpred-2-Auto model.
# 
# 
# 
