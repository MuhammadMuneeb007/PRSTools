...
# |---------------|--------------------------------------------------------------------------------------------------|
# | `-h, --help`  | Show help message and exit.                                                                      |
# | `--cf CF`     | Coordinated file (generated using `ldpred coord`). Full path filename.                          |
# | `--ldr LDR`   | LD radius. Number of SNPs on each side of the focal SNP for which LD should be adjusted.        |
# | `--out OUT`   | Output Prefix for SNP weights.                                                                   |
# | `--p P [P ...]` | P value thresholds.                                                                             |
# | `--r2 R2 [R2 ...]` | LD R2 thresholds. Maximum LD squared correlation allowed between any SNPs within the given LD-radius. |
#                                                                |
# 
# ## References
# 
