...
# 3. Pass the output of the LDSC to smtpred to calculate the weighted betas.
...
# 
# ```
# **Note: One need to install all the files required by LDSC to calculate heritability using GWAS**
# 
# #### Download LDSC file
# 
