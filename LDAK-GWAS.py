...
#    
# 2. **Using Genotype Data**: You can generate GWAS from the training genotype data and follow the same steps as mentioned above to calculate PRS.
# 
# You can download LDAK from [this link](https://dougspeed.com/downloads2/), and the documentation for PRS calculation is available [here](https://dougspeed.com/megaprs/). The documentation provides detailed descriptions of all the steps.
# 
