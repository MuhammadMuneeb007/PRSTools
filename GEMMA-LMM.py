...
# 
# 
# ### Gemma-LMM Parameters We Considered
# 
...
# 
# It also provides three Linear Mixed Models (LMM) for beta estimation, which can be invoked using `1`, `2`, or `3` in the following command via the `-lmm` option:
# 
# ```python
# command = [
#     "./gemma",
