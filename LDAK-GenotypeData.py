...
# 
# 1. **Using Existing GWAS**: You can use the existing GWAS data and genetic correlations for regions in high linkage disequilibrium, calculated using LDAK, to estimate the betas.
#    
# 2. **Using Genotype Data**: You can generate GWAS from LDAK using the training genotype data and then use that GWAS to generate the PRS for both the training and the test set.
#  
# 
# 
# 
# 
# You can download LDAK from [this link](https://dougspeed.com/downloads2/), and the documentation for GWAS calculation is available [here](https://dougspeed.com/single-predictor-analysis/). The documentation provides detailed descriptions of all the steps.
# 
