...
# # tlpSum
# 
# tlpSum is similar to lassosum [https://github.com/jpattee/penRegSum](https://github.com/jpattee/penRegSum) and requires almost similar arguments. To install tlpSum, install R, devtools, lassosum, and then penRegSum, which contains tlpSum.
#  
# ## Install tlpSum
# ```r
