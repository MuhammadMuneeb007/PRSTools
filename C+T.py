...
def fit_binary_phenotype_on_PRS(traindirec, newtrainfilename,p,clumpingandpruningtime, p1_val, p2_val, p3_val, c1_val, c2_val, c3_val,Name,pvaluefile):
    ...
    tempphenotype_test = pd.read_table(traindirec+os.sep+testfilename +".fam", sep="\s+",header=None)
        ...
        for l1weight in l1weights:
            ...
            for i in threshold_values:
                ...
                prs_result = prs_result._append({
                    ...
                    "clumpingandpruningtime":str(clumpingandpruningtime),
...
# This function fit the binary model on the PRS.
def fit_continous_phenotype_on_PRS(traindirec, newtrainfilename,p,clumpingandpruningtime, p1_val, p2_val, p3_val, c1_val, c2_val, c3_val,Name,pvaluefile):
    threshold_values = allpvalues
...
"./plink",
"--make-bed",
"--bfile", folddirec+os.sep+newtrainfilename,
 
"--out", folddirec+os.sep+newtrainfilename+"candt"

]
subprocess.run(command)
def transform_plink_data(traindirec, newtrainfilename,p,clumpingandpruningtime, p1_val, p2_val, p3_val, c1_val, c2_val, c3_val,Name,pvaluefile):
    ### First perform clumping on the file and save the clumpled file.
    
    command = [
    "./plink",
    "--bfile",  traindirec+os.sep+newtrainfilename+"candt",
    ...
    "--indep-pairwise", p1_val, p2_val, p3_val,
    "--extract", traindirec+os.sep+trainfilename+".valid.snp",
    "--out",  traindirec+os.sep+newtrainfilename+"candt"
    ...
    command = [
        ...
        "--score", filedirec+os.sep+filedirec+".txt", "3", "4", "9", "header",
    ...
    if check_phenotype_is_binary_or_continous(filedirec)=="Binary":
        ...
        fit_binary_phenotype_on_PRS(traindirec, newtrainfilename,p,clumpingandpruningtime, p1_val, p2_val, p3_val, c1_val, c2_val, c3_val,Name,pvaluefile)
    else:
        print("Continous Phenotype!")
        fit_continous_phenotype_on_PRS(traindirec, newtrainfilename,p,clumpingandpruningtime, p1_val, p2_val, p3_val, c1_val, c2_val, c3_val,Name,pvaluefile)
            
 
result_directory = "CandT"
#This parameter defines how many times you want to perform the clumping and pruning.
# It perform clumping and pruining on the data multiple types and overrides the orginial data.
clumpingandpruningtimes = 5
# Nested loops to iterate over different parameter values
create_directory(folddirec+os.sep+"CandT")
    ...
    for c2_val in clump_r2:
     for c3_val in clump_kb:
      for p in numberofpca:
        for clumpingandpruningtime in range(0,clumpingandpruningtimes):
         transform_plink_data(folddirec, newtrainfilename, p,clumpingandpruningtime, str(p1_val), str(p2_val), str(p3_val), str(c1_val), str(c2_val), str(c3_val), "CandT", pvaluefile)
...
# 
# 1. `SampleData1/Fold_0/C+T/Results.csv`
# 2. `SampleData1/Fold_1/C+T/Results.csv`
# 3. `SampleData1/Fold_2/C+T/Results.csv`
# 4. `SampleData1/Fold_3/C+T/Results.csv`
# 5. `SampleData1/Fold_4/C+T/Results.csv`
# 
