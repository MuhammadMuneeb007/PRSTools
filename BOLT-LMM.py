...
#     ```
# 
# **Documentation:** Available at [BOLT-LMM Manual](https://storage.googleapis.com/broad-alkesgroup-public/BOLT-LMM/downloads/BOLT-LMM_v2.4.1_manual.pdf)
# 
# ## GWAS for BOLT
# 
...
def transform_bolt_lmm_data(traindirec, newtrainfilename,mm,numberofpca, p1_val, p2_val, p3_val, c1_val, c2_val, c3_val,Name,pvaluefile):
    ...
    #'--qCovarCol=COV_{1:'+str(len(columns)-6)+'}',
